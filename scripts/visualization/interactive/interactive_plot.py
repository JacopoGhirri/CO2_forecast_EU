...
Data files:
    - Dataset pickle: data/pytorch_datasets/unified_dataset.pkl
    - MC projections:  data/projections/mc_projections.csv
    - Precomputed CI:  data/calibration/interactive_ci.csv
      (generated by scripts/visualization/precompute_interactive_ci.py)
...
with col2:
    if calibration_available:
        st.success("✅ MC uncertainty intervals active")
    else:
