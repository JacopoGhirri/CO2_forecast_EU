...
output_configs["grouping_structure"] = {
    ...
    "Mobility": [
        ...
        "G-Trade,VehicleRepair",
        "TransportbyHousehold",
    ],
    "Power": ["D-Electricity,Gas,Steam,AirConditioning"],
    "Other": [
        "Q-Health",
        "M-Science,Technical,Professional",
        "K-Finance,Insurance",
        "J-Information,Communication",
        "R-Arts,Entertainement",
        "S-OtherService",
        "T-HouseholdasemployersActivities",
        "O-PublicAdmin,Defence",
        "OtherbyHousehold",
        "U-ExtraterritorialOrgsActivities",
        "N-Administrative",
        "L-RealEstate",
